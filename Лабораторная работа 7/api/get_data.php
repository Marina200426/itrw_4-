...
/**
 * Endpoint для получения списка пользователей, статей, комментариев и лайков
 * GET /api/get_data
 */
...
try {
    ...
    // Получаем все лайки статей с информацией о пользователях
    $postLikes = $pdo->query('
        SELECT 
            pl.uuid,
            pl.post_uuid,
    ...
    // Получаем все лайки комментариев с информацией о пользователях
